...
local Window = Rayfield:CreateWindow({
	Name = "Blox Fruits - Razu Hub",
	LoadingTitle = "Blox Fruits - Razu Hub",
	LoadingSubtitle = "Subscribe to Razosnpu on YouTube!",
})
...
local Label = Tab:CreateLabel("Thanks for using Razu Hub!")
local Label = TabUtil:CreateLabel("Thanks for using Razu Hub!")
local Label = TabOther:CreateLabel("Thanks for using Razu Hub!")
local Label = TabMobile:CreateLabel("Thanks for using Razu Hub!")
